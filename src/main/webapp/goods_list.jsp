                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="sender" id="sample-table-2_info">
                                                共 ${pageCount} 条记录，每页 ${size} 条，当前页第 ${page}页， 共 ${pageNo} 页
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="dataTables_paginate paging_bootstrap sender">
                                                ...
                                                <ul class="pagination">
                                                    ...
                                                    <li><a href="goods.do?page=2" >2</a></li>--%>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${page>1}">
                                                               <li><a href="goods.do?m=selectGoodsByPage&page=${page-1}">上一页</a></li>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <li><a href="">上一页</a></li>
                                                            </c:otherwise>
                                                        ...
                                                        <c:forEach var="i" begin="1" end="${pageNo}">
                                                            <li><a href="goods.do?m=selectGoodsByPage&page=${i}">${i}</a></li>
                                                        </c:forEach>
                                                        <!-- 判断是否使用下一页连接 -->
                                                        <c:choose>
                                                            <c:when test="${page<pageNo}">
                                                                <li><a href="goods.do?m=selectGoodsByPage&page=${page+1}">下一页</a></li>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <li><a href="">下一页</a></li>
                                                            </c:otherwise>
