                    ...
                    <div class="widget-main">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="file" name="goodPic" id="smfile&quot;" style="width:540px;height:22px;cursor:hand" class="fileinput" onchange="checkImgType(this);setPreview(this,'sm_yl','sm_div',240,150);">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="file" name="goodPic1" id="smfile1&quot;" style="width:540px;height:22px;cursor:hand" class="fileinput" onchange="checkImgType(this);setPreview(this,'sm_yl1','sm_div1',240,150);">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="file" name="goodPic2" id="smfile2&quot;" style="width:540px;height:22px;cursor:hand" class="fileinput" onchange="checkImgType(this);setPreview(this,'sm_yl2','sm_div2',240,150);">
                                </td>
                            </tr>
